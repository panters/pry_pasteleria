...
$(document).ready(function() {
  ...
  var table=$('#example').DataTable({
    ...
    function verNuevo(){
    	...
    	limpiarfields();
    	modal.find('.modal-header h4').text('Registrar Rol: ');
    	modal.find('.modal-body #idRol').val('0');
    	$("#delete").hide();
    };
				  ...
				  //si no es valido no hacemos nada
					...
					$.ajax({
						...
						success:function(data){
							$.growl(
								{
									title:" <strong>Rol: "+data.rol.descripcion+"</strong> ",
...
<div class="modal-dialog">
  ...
  <s:form id="RegistroRol" action="createRol" enctype="multipart/form-data" method="post" acceptcharset="utf-8" theme="bootstrap" cssClass="animate-form well form-vertical">
