...
$(document).ready(function() {
  ...
  var table=$('#example').DataTable({
    ...
    function verNuevo(){
    	...
    	limpiarfields();
    	modal.find('.modal-header h4').text('Registrar Cobertura: ');
    	modal.find('.modal-body #idCobertura').val('0');
    	$("#delete").hide();
    };
  ...
  <s:form id="Registro" action="createCoverage" enctype="multipart/form-data" method="post" acceptcharset="utf-8" theme="bootstrap" cssClass="animate-form well form-vertical">
    <div class="modal-header">
		...
		<div class="modal-body">
	    		<s:hidden id="idCobertura" name="cobertura.idCobertura" />
	    	<div class="form-group">
		   		<s:textfield label="Cobertura :" name="cobertura.descripcion" id="descripcion" cssClass="form-control" onkeypress="return validarLetra(event)"/>
	    	</div>
