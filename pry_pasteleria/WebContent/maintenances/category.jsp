  ...
  var table=$('#example').DataTable({
    ...
    $('#example tbody').on( 'dblclick', 'tr', function () {
       ...
       if ( $(this).hasClass('selected') ) {
           ...
           var dato1=currentRow.idCategoria;
    ...
    function mostrarmodal(dato1,dato2){
		  ...
		  var modal = $(this);
		  modal.find('.modal-header h4').text('Modificar Categoria: ' + dato1);
	
		  modal.find('.modal-body #idCategoria').val(dato1);
    ...
    function verNuevo(){
    	...
    	limpiarfields();
    	modal.find('.modal-header h4').text('Registrar Categoria: ');
    	modal.find('.modal-body #idCategoria').val('0');
    	$("#delete").hide();
    };
	...
	$('#btnNuevo').click(function(){
	  ...
	  $('#delete').click(function(){
	      	$('#borrame').remove();
	      	var modal = $('#myModalNuevo');
	      	var id=modal.find('.modal-body #idCategoria').val();
	      	var c1="<a id=\"borrame\" class=\"btn btn-primary \" ";
	      	var str1 = "href=\"deleteCategory?categoria.idCategoria=";
	        var str2 = "\">Si</a>";
	  ...
	  $('#RegistroCategoria').submit(function(event){
				  ...
				  //si no es valido no hacemos nada
					...
					$.ajax({
						...
						success:function(data){
							$.growl(
								{
									title:" <strong>Rol: "+data.categoria.descripcion+"</strong> ",
...
<div class="modal-dialog">
  ...
  <s:form id="RegistroCategoria" action="createCategory" enctype="multipart/form-data" method="post" acceptcharset="utf-8" theme="bootstrap" cssClass="animate-form well form-vertical">
    <div class="modal-header">
    	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    	<h4>Registrar Categoria</h4>
    </div>
		<div class="modal-body">
	    		<s:hidden id="idCategoria" name="categoria.idCategoria" />
	    	<div class="form-group">
		   		<s:textfield label="Categoria :" name="categoria.descripcion" id="descripcion" cssClass="form-control"/>
	    	</div>
